<template>
    <div class="bg-gradient-to-br from-slate-800 to-slate-900 text-white">
        ...
        <div class="container mx-auto py-2 pb-10">
            ...
            <h1 class="text-4xl mb-10">รายละเอียดอาจารย์</h1>
            <p class="text-2xl mb-4">ชื่ออาจารย์ : <b v-if="pending">กำลังโหลดข้อมูล</b><b v-else>{{ teacherName
                    }}</b></p>
                    ...
                    <div class="overflow-y-auto max-h-[calc(100vh-250px)] custom-scrollbar">
                        ...
                        <div v-else class="p-2 space-y-2">
                            <p v-if="subjects.length === 0" class="my-3 text-center text-slate-400">
                                ไม่มีรายวิชาที่สอน</p>

                            <!-- แสดงรายวิชาที่สอนโดยอาจารย์ท่านนี้ -->
                            <div v-else v-for="(subject, index) in subjects" :key="index"
                                class="
            ...
            <div class="flex justify-between items-center">
                <p>ตารางสอน</p>
                <USelect placeholder="เลือกภาคการศึกษา" color="primary" variant="outline"
                    :items="['เทอม 1/68', 'เทอม 2/68']" class="w-1/4 my-4" />
            </div>
            <!-- ตารางสอน -->
            <div class="grid grid-cols-14 mt-1 text-center">
                ...
                <template v-for="(day, index) in days" :key="index">
                    ...
                    <div v-for="(slot, i) in scheduleSlots[index].slice(0, 4)" :key="`morning-${index}-${i}`"
                        ...
                        <USelect placeholder="ว่าง" v-model="slot.value" :items="subjectOptions" value-key="id_subject"
...
const timeSlots = [
    ...
    '18:00 - 19:00', '19:00 - 20:00', '20:35 - 22:35'
]
