    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="flex flex-col md:flex-row justify-between items-center mb-10 gap-6">
        ...
        <div class="flex items-center gap-3 bg-slate-50 p-2 rounded-2xl border border-slate-200">
          <USelect v-if="termOptions.length > 0" v-model="selectedTerm" :items="filterTermOptions"
            placeholder="เลือกเทอม" class="w-48 cursor-pointer" variant="subtle" icon="i-heroicons-funnel" size="xl" />
      ...
      <div v-else-if="!sections || sections.length === 0"
        ...
        <div
          ...
          <UIcon name="i-heroicons-user-group" class="w-12 h-12 text-slate-500" />
        </div>
        ...
        <div v-for="section in sections" :key="section.id_section"
          ...
          <div class="p-6">
            ...
            <div class="flex gap-3 mt-auto">
              <UButton v-if="terms && terms.length > 0" block label="จัดการตารางเรียน" icon="i-heroicons-calendar"
                color="primary" variant="solid" size="xl" class="rounded-xl flex-1 font-bold"
      ...
      <template #content>
        <div class="flex flex-col max-h-[85vh]">
          <div class="p-8 overflow-y-auto custom-scrollbar flex-1">
            ...
            <form class="space-y-6" @submit.prevent="handleAddSection">
      ...
      <template #content>
        <div class="flex flex-col max-h-[85vh]">
          <div class="p-8 overflow-y-auto custom-scrollbar flex-1">
            ...
            <form class="space-y-6" @submit.prevent="handleEditSection">
