<template>
  <div class="min-h-screen bg-slate-900 text-white pb-20">
      ...
      <div class="container mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div class="flex flex-wrap justify-center gap-4">
          <div class="bg-slate-900/50 px-6 py-3 rounded-2xl border border-slate-700 backdrop-blur-sm min-w-[140px]">
            ...
            <p class="text-2xl font-black text-white">{{ teachers?.length || 0 }} <span class="text-xs font-normal text-slate-500">ท่าน</span></p>
          </div>
          
          <div class="flex items-center gap-3">
            <UInput
              v-model="name"
              placeholder="กรอกชื่ออาจารย์ใหม่..."
              size="xl"
    ...
    <div class="container mx-auto px-4">
      ...
      <div class="mb-8 flex flex-col md:flex-row gap-4 items-center justify-between">
        <div class="relative w-full md:w-96 group">
          <UInput
            ...
            size="xl"
            class="rounded-2xl bg-slate-800/50"
            variant="none"
          />
          <div class="absolute bottom-0 left-0 right-0 h-0.5 bg-blue-500 transform scale-x-0 group-focus-within:scale-x-100 transition-transform duration-300"></div>
        </div>
      </div>
      ...
      <!-- Content -->
      <div v-else>
        <div v-if="filteredTeachers && filteredTeachers.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          <div
          ...
          >
            ...
            <div class="absolute -right-4 -top-4 opacity-[0.03] rotate-12 group-hover:scale-110 transition-transform duration-700">
            ...
            <div class="flex flex-col items-center text-center relative z-10">
              ...
              <div class="flex items-center gap-1.5 px-3 py-1 bg-slate-900/50 rounded-full border border-slate-700/50 mb-6 font-bold text-xs text-slate-400">
              ...
              <div class="flex items-center gap-3 w-full">
                ...
                <div class="flex gap-1">
                  ...
                  <UButton
                    ...
                    color="error"
                    variant="soft"
                    class="rounded-xl border-red-500/10"
        ...
        <!-- Empty State -->
        <div v-else class="text-center py-32 bg-slate-800/30 rounded-[40px] border border-dashed border-slate-700 relative overflow-hidden">
          ...
          <div class="relative z-10">
            ...
            <h3 class="text-2xl font-bold text-slate-400 mb-2">
              {{ searchQuery ? 'ไม่พบมรายชื่อที่ค้นหา' : 'ยังไม่มีรายชื่ออาจารย์ในระบบ' }}
            </h3>
            <p class="text-slate-600 mb-8">กรุณากรอกชื่อในแถบ Header เพื่อเพิ่มอาจารย์คนแรกค่ะ</p>
          </div>
        </div>
      </div>
    ...
    >
      <template #content>
        <div class="p-8">
          ...
          <p class="text-slate-400 text-center mb-8 truncate-2-lines">คุณแน่ใจหรือไม่ที่จะลบรายชื่ออาจารย์ท่านนี้? การลบจะทำให้ข้อมูลตารางสอนทั้งหมดหายไปด้วยนะคะ</p>
          ...
          <div class="bg-red-500/5 border border-red-500/20 p-6 rounded-2xl mb-8 text-center relative overflow-hidden">
             <div class="relative z-10">
                ...
                <div class="flex items-center justify-center gap-3">
                  <UAvatar :alt="selectedTeacherForDelete?.name.toUpperCase()" size="lg" :ui="{ background: 'bg-red-500/20 text-red-500 font-black' }" />
        ...
        <div class="p-8">
          <div class="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p class="text-slate-400 text-sm">การเปลี่ยนชื่อจะไม่ส่งผลต่อประวัติการสอนชดเชยค่ะ</p>
            </div>
          </div>
          ...
          <div class="space-y-6">
            <div>
              ...
              <div class="p-4 bg-slate-800 rounded-2xl text-slate-300 border border-slate-700 font-bold italic">{{ seletedTeacher?.name }}</div>
            </div>
          ...
          <div class="flex gap-3 mt-10">
            <UButton
              ...
              size="xl"
              block
              class="rounded-2xl py-4 flex-1 font-bold font-heading"
