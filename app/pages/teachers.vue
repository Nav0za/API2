      ...
      <div class="container mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        <div>
          ...
          <p class="text-slate-600 mt-1">
            จัดการข้อมูลอาจารย์ผู้สอนและวิชาที่รับผิดชอบ
          </p>
        </div>
    ...
    <div class="container mx-auto px-4">
      ...
      <div class="mb-8 flex flex-col md:flex-row gap-4 items-center justify-between">
        <div class="relative w-full md:w-96 group">
          <UInput
            ...
            size="xl"
            class="rounded-2xl bg-slate-50 w-full"
            variant="none"
      ...
      >
        <UIcon
          ...
          class="w-10 h-10 animate-spin text-amber-500"
        />
      </div>
              ...
              <div class="flex items-center gap-3 w-full">
                ...
                <div class="flex gap-1">
                  <UButton
                    ...
                    color="warning"
                    variant="soft"
                    class="rounded-xl border border-amber-500/10 cursor-pointer"
                  ...
                  <UButton
                    ...
                    color="error"
                    variant="soft"
                    class="rounded-xl border-red-500/10 cursor-pointer"
        ...
        >
          <div class="relative z-10">
            ...
            <p class="text-slate-500 mb-8">
              กรุณากรอกชื่อในแถบ Header เพื่อเพิ่มอาจารย์คนแรก
            </p>
          </div>
        </div>
      </div>
      ...
      <template #content>
        <div class="flex flex-col max-h-[85vh]">
          <div class="p-8 overflow-y-auto custom-scrollbar flex-1">
            ...
            <p class="text-slate-600 text-center mb-8 truncate-2-lines">
              คุณแน่ใจหรือไม่ที่จะลบรายชื่ออาจารย์ท่านนี้?
              การลบจะทำให้ข้อมูลตารางสอนทั้งหมดหายไปด้วยนะคะ
            </p>

            <div class="bg-red-500/5 border border-red-500/20 p-6 rounded-2xl text-center relative overflow-hidden">
              <div class="relative z-10">
                <p class="text-xs font-black uppercase tracking-widest text-red-400/80 mb-2">
                  อาจารย์ที่เลือก
                </p>
                <div class="flex items-center justify-center gap-3">
                  <UAvatar
                    :alt="formatName(selectedTeacherForDelete).toUpperCase()"
                    size="lg"
                    :ui="{ background: 'bg-red-500/20 text-red-500 font-black' }"
                  />
                  <p class="text-2xl font-black text-white">
                    {{ formatName(selectedTeacherForDelete) }}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="flex flex-col max-h-[85vh]">
          <div class="p-8 overflow-y-auto custom-scrollbar flex-1">
            <div class="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p class="text-slate-600 text-md">
                  การเปลี่ยนชื่อจะไม่ส่งผลต่อประวัติการสอนชดเชย
                </p>
              </div>
            </div>
            ...
            <div class="space-y-6">
              <div>
                <label
                  class="text-lg font-black uppercase tracking-widest text-slate-500 mb-2 block"
                >ชื่อปัจจุบัน</label>
                <div class="p-4 rounded-2xl text-slate-900 border border-slate-300 font-bold italic">
                  {{
                    formatName(seletedTeacher) }}
                </div>
              </div>
          ...
          <div class="p-6 border-t border-slate-200 bg-white/95 backdrop-blur-sm sticky bottom-0 z-10">
            <div class="flex gap-3">
              <UButton
                ...
                size="xl"
                block
                class="rounded-2xl py-4 flex-1 font-bold font-heading cursor-pointer"
